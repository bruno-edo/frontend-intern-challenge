# Desafio estagiário: HTML/CSS/JS chaordic

    Página criada por: Bruno Eduardo D'Angelo de Oliveira.

    Mockup funcional criado utilizando: HTML, CSS e Javascript.

    Features:

     - JSON é consumido para se gerar o top 5;
     - Interação de fade-in/fade-out implementada;
